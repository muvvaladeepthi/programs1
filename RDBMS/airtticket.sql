...
marks(htno,name,branch,m1,m2,m3,total)

insert into air_flight values(&htno,'&name','&branch',&m1,&m2,&m3);
Enter new value for htno:1001
Enter new Value for name:KUMAR
Enter new Value for branch:air_credit_card_details
...
values 
( '916',   '28-04-13','4086.00',40), 
('916','12-05-13', '3023.00', 40), 
('916', '01-05-13','4086.00', 40), 
('916','06-05-13','3603.00', 38), 
